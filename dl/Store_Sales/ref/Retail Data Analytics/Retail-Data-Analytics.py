...
# refer: https://www.kaggle.com/feronial/lstm-with-keras

import os
print(os.listdir("./kaggle/input/Retail Data Analytics/"))
import matplotlib.pyplot as plt
import seaborn as sns
from sklearn.preprocessing import LabelEncoder, OneHotEncoder, MinMaxScaler

store_df = pd.read_csv('./kaggle/input/Retail Data Analytics/stores data-set.csv')
features_df = pd.read_csv('./kaggle/input/Retail Data Analytics/Features data set.csv')
main_df = pd.read_csv('./kaggle/input/Retail Data Analytics/sales data-set.csv')
